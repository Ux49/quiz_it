(function () {
    const quizData = {
        ...
        11: [
            {
                question: "In Linux, what is the role of the 'init' process?",
                answers: ["It is the first process started by the kernel, PID 1", "It manages user logins", "It runs network services", "It compiles the kernel"],
                correct: 0
            },
            {
                question: "What is the purpose of a hypervisor?",
                answers: ["To create and run virtual machines by separating the OS from hardware", "To manage databases", "To encrypt network traffic", "To compile code"],
                correct: 0
            },
            {
                question: "In JavaScript, what is the difference between '== ' and '==='?",
                answers: ["'===' compares value and type without type coercion", "'===' compares only value", "They are identical", "'===' is for numbers only"],
                correct: 0
            },
            {
                question: "What is a trie data structure used for?",
                answers: ["Efficient retrieval of keys, often for prefix matching", "Sorting integers", "Graph traversal", "Encryption"],
                correct: 0
            },
            {
                question: "What is the Linux 'cgroups' feature?",
                answers: ["Limits, accounts for, and isolates resource usage of process groups", "Manages user groups", "Controls network access", "Encrypts file systems"],
                correct: 0
            },
            {
                question: "In networking, what is an Autonomous System?",
                answers: ["A collection of IP routing prefixes under one administrative control", "A self-driving vehicle network", "A type of encryption", "A cloud service"],
                correct: 0
            },
            {
                question: "What does 'immutable infrastructure' mean?",
                answers: ["Infrastructure that is never modified after deployment; replaced instead of updated", "Infrastructure that cannot be changed", "Static IP infrastructure", "Physical servers only"],
                correct: 0
            },
            {
                question: "In Python, what is an asyncio event loop?",
                answers: ["The core of asynchronous execution, managing and distributing tasks", "A loop for GUI events", "A threading model", "A debugging tool"],
                correct: 0
            },
            {
                question: "What is a Byzantine fault?",
                answers: ["A fault where components may fail arbitrarily, including malicious behavior", "A hardware failure", "A network timeout", "A database corruption"],
                correct: 0
            },
            {
                question: "How does a consistent hashing ring work?",
                answers: ["Distributes keys across nodes, minimizing reorganization when nodes are added/removed", "Hashes passwords securely", "Creates digital signatures", "Encrypts data streams"],
                correct: 0
            }
        ],
        12: [
            {
                question: "In Linux, what is a 'load average'?",
                answers: ["The average number of processes in a runnable or uninterruptible state over a period", "CPU temperature", "Memory usage percentage", "Network throughput"],
                correct: 0
            },
            {
                question: "What is the CAP theorem's consistency model in practical distributed databases?",
                answers: ["Linearizability", "Eventual consistency", "Snapshot isolation", "Serializability"],
                correct: 0
            },
            {
                question: "In JavaScript, how does prototypal inheritance differ from classical?",
                answers: ["Objects inherit directly from other objects", "It uses classes like Java", "It doesn't support inheritance", "It requires interfaces"],
                correct: 0
            },
            {
                question: "What is the purpose of the Raft consensus algorithm?",
                answers: ["To achieve consensus in a distributed system, ensuring log replication and leader election", "To sort data", "To compress files", "To manage user permissions"],
                correct: 0
            },
            {
                question: "In Linux kernel, what is a 'task_struct'?",
                answers: ["The data structure representing a process or thread", "A file system entry", "A network packet", "A memory page"],
                correct: 0
            },
            {
                question: "What is an LDAP injection?",
                answers: ["An attack that exploits vulnerable LDAP statements to modify directory queries", "A SQL injection variant", "A DNS attack", "A physical security breach"],
                correct: 0
            },
            {
                question: "In system design, what is a write-ahead log?",
                answers: ["A log where changes are recorded before actual data modification, ensuring durability", "A network log", "A backup script", "A monitoring tool"],
                correct: 0
            },
            {
                question: "What is 'thrashing' in operating systems?",
                answers: ["When the system spends more time swapping pages than executing processes", "High CPU usage", "Network congestion", "Disk fragmentation"],
                correct: 0
            },
            {
                question: "What does 'eBPF' stand for and what does it do?",
                answers: ["Extended Berkeley Packet Filter; allows sandboxed programs to run in the Linux kernel without changing kernel source", "Enhanced Binary Protocol Firewall", "External Bandwidth Performance Function", "Embedded Basic Packet Filter"],
                correct: 0
            },
            {
                question: "In graph theory, what problem does the 'traveling salesman' solve?",
                answers: ["Finding the shortest possible route visiting each vertex exactly once", "Maximizing network flow", "Finding spanning tree", "Sorting nodes"],
                correct: 0
            }
        ]
    };
